...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-32 h-32 bg-accent/20 rounded-full blur-2xl animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-40 left-20 w-16 h-16 bg-secondary/20 rounded-full blur-lg animate-float" style={{ animationDelay: '4s' }} />
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 py-6">
            <div className="text-center">
              ...
              <div className="text-sm text-foreground/60">Disponibilidade</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold gradient-text">80%</div>
              <div className="text-sm text-foreground/60">Redução de Custos</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold gradient-text">5x</div>
              <div className="text-sm text-foreground/60">Mais Eficiência</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 glow-primary group"
            >
              Descobrir Soluções
          ...
          <div className="pt-8 text-center">
            <p className="text-sm text-foreground/60 mb-4">Já confiaram em nós</p>
            <div className="flex justify-center items-center space-x-8 opacity-50">
              <div className="w-20 h-8 glass-card rounded flex items-center justify-center">
